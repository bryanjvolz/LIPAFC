<section id="results" class="results">
  <div class="container">
    ...
    <table class="all-time all-time--regular">
    ...
    <table class="all-time all-time--playoffs">
    ...
    <table class="all-time all-time--open-cup">
    ...
    <hr>
      ...
      <table id="match-results" class="match-results" aria-live="polite">
