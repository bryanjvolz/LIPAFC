...
export function Header() {
  ...
  return (
    <>
    <header>
      <nav className={`main-nav ${navActive ? 'active-mobile-nav' : 'inactive-mobile-nav' }`} aria-label="main navigation">
        ...
        <div className={`menu-toggle ${navActive && "animate" }`} aria-label="Mobile Navigation Toggle" tabIndex={0} onClick={mobileNav}></div>
