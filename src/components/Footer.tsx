    ...
    <footer>
      <div className="container">
        <ul className='team-links'>
          <li className="title">The Teams</li>
        ...
        <ul className='supporter-links'>
          <li className="title">The SGs</li>
          ...
          <li><a href="//slaughterhousenineteen.com/" target="_blank" rel="noopener noreferrer">Slaughterhouse 19</a></li>
        </ul>
      </div>
    </footer>
    </>
